      ...
      <Wrapper>
        <div className="action-block">
          <span
            ...
            onClick={() => setUrlParams('view', 'column', params, router)}
          >
            <Icon type="column" />
            Column View
          </span>
          <span
            ...
            onClick={() => setUrlParams('view', 'table', params, router)}
          >
            <Icon type="table" />
            Table View
          </span>
        ...
        <div className="action-block">
          <DropDown title="Sort" icon="sort" className="action-dropdown">
            <a
              onClick={() => setUrlParams('sort', 'title', params, router)}
              className={sortType === 'title' ? 'active' : ''}
            >
              <span>Name (A-Z)</span>
            </a>
            <a
              onClick={() => setUrlParams('sort', 'status', params, router)}
              className={sortType === 'status' ? 'active' : ''}
            >
              <span>Status</span>
            </a>
            <a
              onClick={() => setUrlParams('sort', 'created', params, router)}
              className={sortType === 'created' ? 'active' : ''}
            >
              <span>Date Created</span>
            </a>
            <a
              onClick={() => setUrlParams('sort', 'updated', params, router)}
